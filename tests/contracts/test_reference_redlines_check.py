...
class ReferenceRedlinesCheckTest(unittest.TestCase):
    ...
    def test_value_error_cannot_directly_silently_fallback_with_empty_string_format_map(self) -> None:
        errors = collect_silent_fallback_exception_errors_for_python_text(
            Path("sample.py"),
            "try:\n    work()\nexcept ValueError:\n    return \"\".format_map({})\n",
        )
    ...
    def test_type_error_cannot_directly_silently_fallback_with_empty_string_format_map_alias(self) -> None:
        errors = collect_silent_fallback_exception_errors_for_python_text(
            Path("sample.py"),
    ...
    def test_os_error_cannot_return_bytearray_wrapped_empty_string_format_map_alias(self) -> None:
        errors = collect_silent_fallback_exception_errors_for_python_text(
            Path("sample.py"),
    ...
    def test_value_error_cannot_directly_silently_fallback_with_empty_string_zfill_width(self) -> None:
        errors = collect_silent_fallback_exception_errors_for_python_text(
            Path("sample.py"),
            "try:\n    work()\nexcept ValueError:\n    return \"\".zfill(0)\n",
        )
    ...
    def test_type_error_cannot_directly_silently_fallback_with_empty_bytes_center_alias(self) -> None:
        errors = collect_silent_fallback_exception_errors_for_python_text(
            Path("sample.py"),
            "try:\n    work()\nexcept TypeError:\n    payload = b\"\"\n    return payload.center(0, b\"x\")\n",
        )
        self.assertEqual(
            errors,
            [
    ...
    def test_os_error_cannot_return_bytearray_wrapped_empty_bytearray_rjust_alias(self) -> None:
        errors = collect_silent_fallback_exception_errors_for_python_text(
            Path("sample.py"),
            "try:\n    work()\nexcept OSError:\n    payload = bytearray()\n    text = payload.rjust(0, b\"x\")\n    return bytearray(text)\n",
        )
        self.assertEqual(
            errors,
            [
