...
from tools.checks.reference_redlines_static_eval import (
    _STATIC_EMPTY_ITERATOR_VALUE,
    _STATIC_VALUE_NOT_AVAILABLE,
    _extract_simple_name_assignment_target_names_and_value,
    _is_direct_silent_fallback_return_value,
    _runtime_value_is_silent_fallback,
    _runtime_value_is_trackable_known_name_assignment_value,
