...
CHECKS: list[tuple[str, list[str], list[str]]] = [
    ...
    (
        ...
        [
            ...
            "--reset",
            "--db",
            "target/smoke/safeclaw-mvp-archive-note/session.db",
            "--archive-root",
            "target/smoke/safeclaw-mvp-archive-note/archive",
            "--archive-date",
            "2026-04-01",
            "--archive-name",
            "Weekly Standup",
            "--content",
            "# Weekly standup\n- shipped readable bill\n",
            "--task-id",
            "task-smoke-mvp-archive-note",
        ],
        [
            "[mvp] accepted task => task=task-smoke-mvp-archive-note effect=effect-task-smoke-mvp-archive-note",
            "[mvp] archive note => created target/smoke/safeclaw-mvp-archive-note/archive/2026-04/2026-04-01-weekly-standup.md",
            "[mvp] archive-note target => task=task-smoke-mvp-archive-note effect=effect-task-smoke-mvp-archive-note",
            "[mvp] governance view => disposition=Resolved worker=Succeeded effect=Executed attempts=1",
            "[mvp] 操作账单 => 已记录 1 个操作",
            "[mvp] 账单条目 => 写入文件 target/smoke/safeclaw-mvp-archive-note/archive/2026-04/2026-04-01-weekly-standup.md（可撤销）",
            "[mvp] output exists => true",
            "[mvp] output content => # Weekly standup\\n- shipped readable bill\\n",
        ],
    ),
    (
        "safeclaw-mvp-undo",
        ...
        [
            "[mvp] undo target => task=task-smoke-mvp-archive-note effect=effect-task-smoke-mvp-archive-note",
            "[mvp] undo result => worker=RolledBack effect=RolledBack compensation=0",
            "[mvp] undo removed => target/smoke/safeclaw-mvp-archive-note/archive/2026-04/2026-04-01-weekly-standup.md",
            "[mvp] governance view => disposition=Resolved worker=RolledBack effect=RolledBack attempts=1",
            "[mvp] 账单条目 => 已撤销 写入文件 target/smoke/safeclaw-mvp-archive-note/archive/2026-04/2026-04-01-weekly-standup.md（已回滚）",
            "[mvp] 账单撤销能力 => 已撤销，无需再次 undo",
            "[mvp] output exists => false",
        ],
    ),
    (
