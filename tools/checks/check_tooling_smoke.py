...
def collect_errors() -> list[str]:
    ...
    elif "[mvp-wrapper] examples => demo | recover-demo | retry-demo | session | sessions --limit 5 | use --index 0 | use --task-id task-demo | forget | doctor" not in wrapper_help_output:
        errors.append("mvp-wrapper-help 输出缺少 task-id 示例提示")
