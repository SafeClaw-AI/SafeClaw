...
- `service-resume`: resume a hibernated task and immediately print the matching service summary; optional `--preflight` / `--enforce-permission` work the same way as `service-run`
